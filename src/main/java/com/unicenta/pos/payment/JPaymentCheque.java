...
*/ 
    ...
    public PaymentInfo executePayment() {
        ...
        transid = jTextField1.getText();
        return new PaymentInfoTicket(m_dPaid, "AZUL",transid,1);
    }
...
public String printAzulId() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html>Transation ID/<br>LINK DE PAGO :");
        jPanel4.add(jLabel1);
        jLabel1.setBounds(0, 70, 120, 60);
