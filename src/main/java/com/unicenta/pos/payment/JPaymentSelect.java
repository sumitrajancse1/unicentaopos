...
public abstract class JPaymentSelect extends javax.swing.JDialog
    ...
    private TicketInfo m_ticket; // Holds the ticket information
...
private void selectPaymentTab(String paymentMethodKey) {
    for (int i = 0; i < m_jTabPayment.getTabCount(); i++) {
        Component comp = m_jTabPayment.getComponentAt(i);
        if (comp instanceof JPaymentInterface) {
            // Iterate over the payments map to find the matching key
            for (Map.Entry<String, JPaymentInterface> entry : payments.entrySet()) {
                if (entry.getKey().equals(paymentMethodKey) && entry.getValue() == comp) {
                    m_jTabPayment.setSelectedIndex(i);
                    return;
                }
            }
        }
...
public class JPaymentUberCreator implements JPaymentCreator {
        @Override
        public JPaymentInterface createJPayment() {
            return new JPaymentUber(JPaymentSelect.this);
        }
        @Override
        public String getKey() {
            return "payment.uber";
        ...
        @Override
        public String getIconKey() {
            return "/com/unicenta/images/uber.png";
        }
    }
public class JPaymentCardnetCreator implements JPaymentCreator {
        @Override
        public JPaymentInterface createJPayment() {
            return new JPaymentCardnet(JPaymentSelect.this);
        }
        @Override
        public String getKey() {
            return "payment.Cardnet";
        }
        @Override
        public String getLabelKey() {
            return "tab.Cardnet";
        ...
        @Override
        public String getIconKey() {
            return "/com/unicenta/images/Cardnet.png";
        }
    }
public class JPaymentHugoCreator implements JPaymentCreator {
        @Override
        public JPaymentInterface createJPayment() {
            return new JPaymentHugo(JPaymentSelect.this);
        }
        @Override
        public String getKey() {
            return "payment.hugo"; 
        ...
        @Override
        public String getIconKey() {
            return "/com/unicenta/images/pedidosya.png";
        }
    }    
