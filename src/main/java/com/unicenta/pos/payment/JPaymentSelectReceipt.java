...
public class JPaymentSelectReceipt extends JPaymentSelect {
    ...
    protected void addTabs() { 
        ...
        addTabPayment(new JPaymentSelect.JPaymentUberCreator());
        addTabPayment(new JPaymentSelect.JPaymentHugoCreator());
        addTabPayment(new JPaymentSelect.JPaymentCardnetCreator());
